...
import { SearchIcon, BellIcon, ChevronDown, ClockIcon, UsersIcon, PlusIcon, XIcon } from "../components/icons";
      ...
      <div style={{ flexGrow: 1, minWidth: 0, minHeight: 0, height: "100%", display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        >
          <button
            ...
            style={{ border: "none", padding: 0, height: "auto", gap: 8, background: "none" }}
            onClick={() => setBreadcrumbOpen((v) => !v)}
            aria-expanded={breadcrumbOpen}
          >
            <h1 style={{ fontSize: 19 }}>{cert.name}</h1>
            <ChevronDown size={13} />
          </button>
